...
function TrashIcon({ onClick }: { onClick: () => void }) {
    return (
        <svg class={classes.trashIcon} onClick={onClick} width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class={classes.settingsPage}>
            <div class={classes.settingsSection}>
                ...
                <div class={classes.themeList}>
                    ...
                    <For each={store().themes} children={(theme) => (
                        <div class={`${classes.themeItem} ${store().active === theme.name ? classes.active : ""}`}>
                            <div class={classes.themeInfo}>
                ...
                <Show when={store().themes.length === 0} children={<div class={classes.noThemes}>No themes installed</div>} />
            </div>
        </div>
    );
}
